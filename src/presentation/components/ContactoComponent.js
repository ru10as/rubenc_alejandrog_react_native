...
const styles = StyleSheet.create({
    ...
    cardTitle: { fontWeight: 'bold', fontSize: 25, textAlign: 'center', padding: 3, marginTop: 15, marginBottom: 15 },
    parrafo: { marginBottom: 10 },
    datosDeContacto: { marginTop: 5 },
    linea: { marginBottom: 20, height: 1, width: '85%', alignSelf: 'center' },
});
